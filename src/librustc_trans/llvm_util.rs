...
const ARM_WHITELIST: &[&str] = &["neon\0", "vfp2\0", "vfp3\0", "vfp4\0"];

const AARCH64_WHITELIST: &[&str] = &["neon\0"];

const X86_WHITELIST: &[&str] = &["avx\0", "avx2\0", "bmi\0", "bmi2\0", "sse\0",
...
const HEXAGON_WHITELIST: &[&str] = &["hvx\0", "hvx-double\0"];

const POWERPC_WHITELIST: &[&str] = &["altivec\0",
                                                     "power8-altivec\0", "power9-altivec\0",
                                                     "power8-vector\0", "power9-vector\0",
                                                     "vsx\0"];

const MIPS_WHITELIST: &[&str] = &["msa\0"];
